...
public class TrendsThread extends Thread{
    ...
    public void run(){
        ...
        if (trendsHA) {
            JPanel[] arr = refreshRefDataForHomeAway(panelTrends.leagueName, panelTrends.parameter, lastOrFull, panelTrends.season, resultList);
            ...
            JPanel panelData = refreshRefDataForAll(panelTrends.leagueName, panelTrends.parameter, lastOrFull, panelTrends.season, resultList);
            if (panelTrends.infoPanel.getComponentCount() > 0) {
                panelTrends.infoPanel.removeAll();
            }
    ...
    public JPanel refreshRefDataForAll(String leagueName, final String parameter, String lastOrFull, String seasonString, ArrayList<String> resultList){
            ...
            if (!panelTrends.lastCalculatedLeague.equals(leagueName) || !panelTrends.lastCalculatedSeason.equals(season) || !panelTrends.lastTrendsHA.equals(homeAwayOrAllAll)){
                ...
                try {
                    ...
                    while (((str = in.readLine()) != null)) {
                        ...
                        selector.getPList(selector.listOfMatches, str);
    ...
    public JPanel[] refreshRefDataForHomeAway(String leagueName, final String parameter, String lastOrFull, String seasonString, ArrayList<String> resultList){
        JScrollPane scrollPane;
            ...
            if (!panelTrends.lastCalculatedLeague.equals(leagueName) || !panelTrends.lastCalculatedSeason.equals(season) || !panelTrends.lastTrendsHA.equals(homeAwayOrAllAll)){
                ...
                try {
                    ...
                    while (((str = in.readLine()) != null)) {
                        ...
                        selectorHT.getPList(selectorHT.listOfMatches, str);
                        ...
                        selectorAT.getPList(selectorAT.listOfMatches, str);
